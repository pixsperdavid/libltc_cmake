 ...
 */
DLL_EXPORT void ltc_frame_to_time(SMPTETimecode* stime, LTCFrame* frame, int flags);
 ...
 */
DLL_EXPORT void ltc_time_to_frame(LTCFrame* frame, SMPTETimecode* stime, enum LTC_TV_STANDARD standard, int flags);
 ...
 */
DLL_EXPORT void ltc_frame_reset(LTCFrame* frame);
 ...
 */
DLL_EXPORT int ltc_frame_increment(LTCFrame* frame, int fps, enum LTC_TV_STANDARD standard, int flags);
 ...
 */
DLL_EXPORT int ltc_frame_decrement(LTCFrame* frame, int fps, enum LTC_TV_STANDARD standard, int flags);
 ...
 */
DLL_EXPORT LTCDecoder * ltc_decoder_create(int apv, int queue_size);
 ...
 */
DLL_EXPORT int ltc_decoder_free(LTCDecoder *d);
 ...
 */
DLL_EXPORT void ltc_decoder_write(LTCDecoder *d,
 ...
 */
DLL_EXPORT void ltc_decoder_write_double(LTCDecoder *d, double *buf, size_t size, ltc_off_t posinfo);
 ...
 * @param posinfo (optional, recommended) sample-offset in the audio-stream.
 */
DLL_EXPORT void ltc_decoder_write_float(LTCDecoder *d, float *buf, size_t size, ltc_off_t posinfo);
 ...
 * @param posinfo (optional, recommended) sample-offset in the audio-stream.
 */
DLL_EXPORT void ltc_decoder_write_s16(LTCDecoder *d, short *buf, size_t size, ltc_off_t posinfo);
 ...
 * @param posinfo (optional, recommended) sample-offset in the audio-stream.
 */
DLL_EXPORT void ltc_decoder_write_u16(LTCDecoder *d, unsigned short *buf, size_t size, ltc_off_t posinfo);
 ...
 */
DLL_EXPORT int ltc_decoder_read(LTCDecoder *d, LTCFrameExt *frame);

/**
 * Remove all LTC frames from the internal queue.
 * @param d decoder handle
 */
DLL_EXPORT void ltc_decoder_queue_flush(LTCDecoder* d);
 ...
 */
DLL_EXPORT int ltc_decoder_queue_length(LTCDecoder* d);
 ...
 */
DLL_EXPORT LTCEncoder* ltc_encoder_create(double sample_rate, double fps, enum LTC_TV_STANDARD standard, int flags);

/**
 * Release memory of the encoder.
 * @param e encoder handle
 */
DLL_EXPORT void ltc_encoder_free(LTCEncoder *e);
 ...
 */
DLL_EXPORT void ltc_encoder_set_timecode(LTCEncoder *e, SMPTETimecode *t);
 ...
 */
DLL_EXPORT void ltc_encoder_get_timecode(LTCEncoder *e, SMPTETimecode *t);
 ...
 */
DLL_EXPORT void ltc_encoder_set_user_bits(LTCEncoder *e, unsigned long data);
 ...
 */
DLL_EXPORT unsigned long ltc_frame_get_user_bits(LTCFrame *f);

/**
 * Move the encoder to the next timecode frame.
 * uses \ref ltc_frame_increment() internally.
 */
DLL_EXPORT int ltc_encoder_inc_timecode(LTCEncoder *e);
 ...
 */
DLL_EXPORT int ltc_encoder_dec_timecode(LTCEncoder *e);
 ...
 */
DLL_EXPORT void ltc_encoder_set_frame(LTCEncoder *e, LTCFrame *f);
 ...
 */
DLL_EXPORT void ltc_encoder_get_frame(LTCEncoder *e, LTCFrame *f);
 ...
 */
DLL_EXPORT int ltc_encoder_get_buffer(LTCEncoder *e, ltcsnd_sample_t *buf) DEPRECATED_EXPORT;
 ...
 * pointed to by buf.
 */
DLL_EXPORT int ltc_encoder_copy_buffer(LTCEncoder *e, ltcsnd_sample_t *buf);
 ...
 */
DLL_EXPORT ltcsnd_sample_t *ltc_encoder_get_bufptr(LTCEncoder *e, int *size, int flush) DEPRECATED_EXPORT;
 ...
 */
DLL_EXPORT int ltc_encoder_get_bufferptr(LTCEncoder *e, ltcsnd_sample_t **buf, int flush);

/**
 * reset the write-pointer of the encoder-buffer
 * @param e encoder handle
 */
DLL_EXPORT void ltc_encoder_buffer_flush(LTCEncoder *e);
 ...
 */
DLL_EXPORT size_t ltc_encoder_get_buffersize(LTCEncoder *e);
 ...
 * @param flags binary combination of \ref LTC_BG_FLAGS
 */
DLL_EXPORT int ltc_encoder_reinit(LTCEncoder *e, double sample_rate, double fps, enum LTC_TV_STANDARD standard, int flags);
 ...
 * @param e encoder handle
 */
DLL_EXPORT void ltc_encoder_reset(LTCEncoder *e);
 ...
 */
DLL_EXPORT int ltc_encoder_set_bufsize(LTCEncoder *e, double sample_rate, double fps) DEPRECATED_EXPORT;
 ...
 *   encoder unusable, call \ref ltc_encoder_free or realloc the buffer)
 */
DLL_EXPORT int ltc_encoder_set_buffersize(LTCEncoder *e, double sample_rate, double fps);
 ...
 */
DLL_EXPORT double ltc_encoder_get_volume(LTCEncoder *e);
 ...
 */
DLL_EXPORT int ltc_encoder_set_volume(LTCEncoder *e, double dBFS);
 ...
 */
DLL_EXPORT double ltc_encoder_get_filter(LTCEncoder *e);
 ...
 */
DLL_EXPORT void ltc_encoder_set_filter(LTCEncoder *e, double rise_time);
 ...
 */
DLL_EXPORT int ltc_encoder_encode_byte(LTCEncoder *e, int byte, double speed);
 ...
 * @return 0 on success, -1 if byte is invalid or buffer overflow (speed > 10.0)
 */
DLL_EXPORT int ltc_encoder_end_encode(LTCEncoder *e);
 ...
 * @param e encoder handle
 */
DLL_EXPORT void ltc_encoder_encode_frame(LTCEncoder *e);
 ...
 * @param e encoder handle
 */
DLL_EXPORT void ltc_encoder_encode_reversed_frame(LTCEncoder *e);
 ...
 */
DLL_EXPORT void ltc_frame_set_parity(LTCFrame *frame, enum LTC_TV_STANDARD standard);
 ...
 */
DLL_EXPORT int ltc_frame_parse_bcg_flags(LTCFrame *frame, enum LTC_TV_STANDARD standard);
 ...
 */
DLL_EXPORT ltc_off_t ltc_frame_alignment(double samples_per_frame, enum LTC_TV_STANDARD standard);
